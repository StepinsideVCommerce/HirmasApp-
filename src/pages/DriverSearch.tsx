    ...
    <div className="flex flex-col h-screen bg-slate-900">
      ...
      <div className="relative w-full h-1/2 bg-slate-800 flex items-center justify-center">
        ...
        <div className="relative">
          ...
          <div
            className="absolute inset-0 w-24 h-24 bg-yellow-500/30 rounded-full animate-ping"
            style={{ animationDelay: "0.2s" }}
          ></div>
          <div
            className="absolute inset-0 w-16 h-16 bg-yellow-500/40 rounded-full animate-ping"
          ...
          {searchStage >= 2 && (
            <div className="relative w-full h-20 mt-8">
              ...
              <div
                ...
                style={{
                  left:
                    searchStage === 3 ? "calc(100% - 2rem - 1.5rem)" : "2rem",
                }}
              >
